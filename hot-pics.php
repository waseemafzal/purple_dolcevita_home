...
<div class="container margin0auto">
    <div class="row">
        <br>
        <img id="media_header_img" class="padding0"src="images/Hot_Picks/Hot_picks1/hot-picks.png">
        <br><br><br>
    </div>
    ...
    <div class="row">
        ...
        <div  class="container margin0auto font_style">
            <div class="row marginbottom115px">
                <!--<img class=" product_img col-xs-12 col-sm-12 padding0"src="images/Media/3-image-slider.jpg">-->
                <ul id="HotPics_slider">
                    <li><a href="#" ><img src="images/Hot_Picks/Hot_picks1/hotpick_aria.png" /></a></li>
                    <li><a href="#" ><img src="images/Hot_Picks/Hot_picks1/text.png" /></a></li>
                    <li><a href="#" ><img src="images/Hot_Picks/Hot_Picks2/hotpick_bohemian.png" /></a></li>
                    <li><a href="#" ><img src="images/Hot_Picks/Hot_Picks2/text.png" /></a></li>
                    <li><a href="#" ><img src="images/Hot_Picks/Hot_Picks3/hotpick_trunks.png" /></a></li>
                    <li><a href="#" ><img src="images/Hot_Picks/Hot_Picks3/text.png" /></a></li>
                </ul>

            </div>
            <br>
            <div class="row">
                <img style="margin:0 0 1% 7%" class="padding0"src="images/Hot_Picks/Hot_picks1/Dolce-Vita-Website-updated-option-5-part-3_23.png"> <br>
