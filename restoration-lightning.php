...
<div class="container margin0auto">
    <div class="row">
        <div>
            <ul class="klmn">
                <li>
                    <img class="col-xs-12"src="images/restoration-living/restoration_living.png">
                </li>
                <li>
                    <img class="col-xs-12"src="images/restoration-living/restoration_living2.png">
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="end-product row">
            ...
            <div class="col-md-6 paddingl32px paddingr0px">
                <div class="end-product-heading">
                    <img src="images/restoration-living/text.png">
                </div>
            </div>
