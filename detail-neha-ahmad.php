...
FB.ui({
    ...
    action_properties: JSON.stringify({
        object : {
           ...
           'og:title': 'Neha Ahmed',
           'og:description': ' Neha Ahmed, Female Models is famous for Modeling, Pakistani celebrity, hot and bold model in Pakistan',
           'og:image': '<?PHP echo SHARE_URL?>images/Media/detail/Neha_Ahmed.jpg'
        }
    })
    },
    // callback
    ...
    <!------container starts ----->
       ...
       <div class="row">
       	<img class="col-xs-12" src="images/Media/detail/Neha_Ahmed.jpg">
       </div>
                  <div class="row">
