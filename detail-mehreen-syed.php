...
FB.ui({
    ...
    action_properties: JSON.stringify({
        object : {
           'og:url': '<?PHP echo SHARE_URL?>detail-mehreen-syed.php/', // your url to share
           ...
           'og:image': '<?PHP echo SHARE_URL?>images/Media/detail/mahreen_Syed.jpg'
        }
    })
    },
    // callback
    ...
    <!------container starts ----->
       ...
       <div class="row">
       	<img class="col-xs-12" src="images/Media/detail/mahreen_Syed.jpg">
       </div>
               <div class="row">
